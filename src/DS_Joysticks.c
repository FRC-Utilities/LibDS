...
void joystick_update_hat (const int index, const int hatId,
                          const DS_Hat angle)
{

}

void joystick_update_axis (const int index, const int axisId,
                           const double value)
{

}

void joystick_update_button (const int index, const int buttonId,
                             const DS_Button pressedState)
{

}

int joystick_add (const char* name, const int numAxes, const int numHats,
