...
/**
 *  \brief  A variable controlling whether updates to the SDL screen surface should be synchronized with the vertical
...
/**
 *  \brief  A variable that lets you enable joystick (and gamecontroller) events even when your app is in the
 * background.
 *
 *  The variable can be set to the following values:
