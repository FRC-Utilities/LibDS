 ...
 *  }
 *
 *  Using the SDL_HINT_GAMECONTROLLERCONFIG hint or the SDL_GameControllerAddMapping you can add support for controllers
 * SDL is unaware of or cause an existing controller to have a different binding. The format is: guid,name,mappings
 *
